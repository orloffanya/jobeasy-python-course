...
elif 10 >= number_1 > 5 or 10 >= number_2 > 5:
    result_2 = (number_1 + number_2)
else:
...
# If a number meets the first condition, find the remainder of random_value divided by 2.
# If it is 0, save the text "Even number" to result_4 , else save the message "Odd number"

random_number = 4
if 10 > random_number or random_number > 99:
